...
class ZeroComprehensionEngine(object):
    ...
    def __init__(self):
        ...
        try:
            ...
            print("Using GPU acceleration, this will be more efficient.")
        except:
            ...
            print("Using CPU only, this will be less efficient.")
    ...
    def free_comprehend(self, comment_text, candidate_labels):
        ...
        response = dict(
            zip(
                zero_classifier_response["premise"]["labels"],
                zero_classifier_response["premise"]["scores"],
            )
        )
        ...
        return "{},{},{}".format(
            comment_text,
            ",".join(string_ints),
            sentiment_classifier_response[0]["label"],
        )
